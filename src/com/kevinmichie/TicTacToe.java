...
public class TicTacToe {
    ...
    public TicTacToe(char playerToken, char markerFromComputer){
        this.userMarker = playerToken;
        this.aiMarker= markerFromComputer;
        this.winner= '-';
        board = setBoard();
    ...
    public boolean isThereAWinner(){
        ...
        boolean topAndFirst = (topRow() || firsCol()) && board[0] != '-';
    ...
    public boolean thirdCol(){
        return board[2] == board[5] && board[1] == board[8];
    }
